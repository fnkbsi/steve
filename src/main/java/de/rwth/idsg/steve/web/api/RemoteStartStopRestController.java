...
public class RemoteStartStopRestController {
    ...
    private ApiChargePointList getChargePoints() {
        List<ChargePointSelect> chargePoints = chargePointService.getChargePoints(OcppVersion.V_12);
        chargePoints.addAll(chargePointService.getChargePoints(OcppVersion.V_15));
        chargePoints.addAll(chargePointService.getChargePoints(OcppVersion.V_16));
        ApiChargePointList lsCp = new ApiChargePointList();
        try {
            for (ChargePointSelect chargeBox : chargePoints) {
                List<Integer> conList = chargePointService.getNonZeroConnectorIds(chargeBox.getChargeBoxId());
                if (!conList.isEmpty()) {
    ...
    public Integer postRemoteStartTx(@Valid ApiChargePointStart params) {
        ...
        Integer transactionId = transactionService.getLatestActiveTransaction(params.getChargeBoxId(),
                params.getConnectorId()).getId();
        ...
        transactionParams.setChargePointSelectList(chargePointService.getChargePointSelect(params.getChargeBoxId()));
        //chargePointService
    ...
    public Integer postRemoteStopTx(@Valid ApiChargePointStart params) {
        ...
        Transaction transaction = transactionService.getLatestActiveTransaction(params.getChargeBoxId(),
                params.getConnectorId());
