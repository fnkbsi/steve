...
public class ChargingProfileRestController {
    ...
    private ApiChargePointList getChargePoints() {
        ...
        List<ChargePointSelect> chargePoints = chargePointService.getChargePoints(OcppVersion.V_16);
    ...
    public ApiChargingProfileAssignments getAssignments(@RequestBody @Valid ChargingProfileAssignmentQueryForm form) {
        ...
        assignmentInfo.setChargeBoxIds(chargePointService.getChargeBoxIds());
    ...
    public Integer getCompositeSchedule(@RequestBody @Valid ApiGetCompositSchedule params) {
        ...
        compositeScheduleParams.setChargePointSelectList(chargePointService.getChargePointSelect(params.getChargeBoxId()));
    ...
    public Integer postSetChargingProfile(@RequestBody @Valid ApiChargingProfile params) {
        ...
        setProfileParams.setChargePointSelectList(chargePointService.getChargePointSelect(params.getChargeBoxId()));
    ...
    public Integer postClearChargingProfile(@RequestBody @Valid ApiChargingProfile params) {
        ...
        clearProfileParams.setChargePointSelectList(chargePointService.getChargePointSelect(params.getChargeBoxId()));
